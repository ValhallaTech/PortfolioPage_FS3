    ...
    $.fn.extend ( {
        ...
        venobox: function ( options )
        {
            ...
            const defaults = {
                ...
                spinner:
                    "double-bounce", // available: 'rotating-plane' | 'double-bounce' | 'wave' | 'wandering-cubes' | 'spinner-pulse' | 'chasing-dots' | 'three-bounce' | 'circle' | 'cube-grid' | 'fading-circle' | 'folding-cube'
                spinColor: "#d2d2d2",
            ...
            return this.each ( function ()
            {
                ...
                obj.on ( "click",
                    function ( e )
                    {
                        ...
                        navigation =
                            `<a class="vbox-next">${ option.htmlNext }</a><a class="vbox-prev">${ option.htmlPrev
                            }</a>`;
                        vbheader =
                        ...
                        core =
                            `<div class="vbox-overlay ${ extraCss }" style="background:${ overlayColor }">${ preloader
                            }<div class="vbox-container"><div class="vbox-content"></div></div>${ vbheader }${
                            navigation }${ vbfooter }</div>`;
                ...
                function checknav ()
                {
                    ...
                    {
                        sharelinks = {
                            pinterest: `<a target="_blank" href="https://pinterest.com/pin/create/button/?url=${
                                obj.prop ( "href" ) }&media=${ obj.prop ( "href" ) }&description=${ title }">${ pinIcon
                                }</a>`,
                            facebook: `<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=${
                                obj.prop ( "href" ) }">${ fbIcon }</a>`,
                            twitter: `<a target="_blank" href="https://twitter.com/intent/tweet?text=${ title }&url=${
                                obj.prop ( "href" ) }">${ twitterIcon }</a>`,
                            linkedin: `<a target="_blank" href="https://www.linkedin.com/sharing/share-offsite/?url=${

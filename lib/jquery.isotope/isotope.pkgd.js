...
( function ( window, factory )
{
    ...
    function factory ( window, matchesSelector )
    {
        var utils = {};
...
( function ( window, factory )
{
    ...
    function factory ( EvEmitter, getSize )
    {
        "use strict";
...
( function ( window, factory )
{
    ...
    function factory ( LayoutMode )
    {
        ...
        {
            item.getSize ();
            const x = ( this.isotope.size.innerWidth - item.size.outerWidth ) * this.options.horizontalAlignment;
            const y = this.y;
...
// -------------------------- isotopeDefinition -------------------------- //
        ...
        proto._getIsInstant = function ()
        {
            ...
            const isInstant = isLayoutInstant !== undefined ? isLayoutInstant : !this._isLayoutInited;

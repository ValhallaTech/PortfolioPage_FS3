...
( function ( $, window, document, undefined )
{
    ...
    Owl.Workers = [
        {
            ...
            run: function ()
            {
                ...
                var // TODO: Should be computed from number of min width items in stage
    ...
    Owl.prototype.add = function ( content, position )
    {
        ...
        if ( this._items.length === 0 || position === this._items.length )
        {
            ...
            this._mergers.push ( content.find ( "[data-merge]" ).addBack ( "[data-merge]" ).attr ( "data-merge" ) * 1
                || 1 );
        }
        else
        {
            ...
            'initialized.owl.carousel change.owl.carousel resized.owl.carousel': $.proxy ( function ( e )
                {
                    ...
                    if ( ( e.property && e.property.name == "position" ) || e.type == "initialized" )
                    {
                        ...
                        let position = ( e.property && e.property.value !== undefined
                                             ? e.property.value
                                             : this._core.current () )
                            + i;
...
( function ( $, window, document, undefined )
{
            ...
            'prepared.owl.carousel': $.proxy ( function ( e )
                {
                    ...
                    {
                        this._templates.push ( `<div class="${ this._core.settings.dotClass }">${ $ ( e.content )
    ...
    Navigation.prototype.initialize = function ()
    {
        ...
        this._controls.$relative = ( settings.navContainer
                                         ...
                                         : $ ( "<div>" ).addClass ( settings.navContainerClass )
    ...
    Navigation.prototype.draw = function ()
    {
        ...
        if ( settings.dots )
        {
            ...
            this._controls.$absolute.children ().eq ( $.inArray ( this.current (), this._pages ) )
                .addClass ( "active" );
        }
    };
    ...
    Navigation.prototype.to = function ( position, speed, standard )
    {
        ...
        {
            length = this._pages.length;
            $.proxy ( this._overrides.to, this._core ) ( this._pages[( ( position % length ) + length ) % length].start,
                speed );
        }
        else
        {
            ...
            'prepared.owl.carousel': $.proxy ( function ( e )
                {
                    if ( e.namespace )
                    {
                        const hash = $ ( e.content ).find ( "[data-hash]" ).addBack ( "[data-hash]" )
                            .attr ( "data-hash" );

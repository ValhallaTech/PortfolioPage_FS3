        ...
        return function ( e )
        {
                    ...
                    M = function ()
                    {
                        w.forEach ( function ( e, t )
                        {
                            e.node.removeAttribute ( "data-aos" ),
                                e.node.removeAttribute ( "data-aos-easing" ), e.node.removeAttribute (
                    ...
                    return S ( x.disable ) || t
                               ...
                               : (
                                   ...
                                   "DOMContentLoaded" === x.startEvent
                                       ...
                                       ? j ( !0 )
                                       : "load" === x.startEvent
                                         ? window.addEventListener ( x.startEvent, function () { j ( !0 ) } )
                                         : document.addEventListener ( x.startEvent, function () { j ( !0 ) } ),
                                   window.addEventListener ( "resize",
                                       ( 0, s.default ) ( j, x.debounceDelay, !0 ) ), window.addEventListener (
                                       "orientationchange",
                                       ( 0, s.default ) ( j, x.debounceDelay, !0 ) ), window.addEventListener (
                                       "scroll",
                                       ( 0, u.default ) ( function () { ( 0, b.default ) ( w, x.once ) },
                                           x.throttleDelay ) ), x.disableMutationObserver
                                       || d.default.ready ( "[data-aos]", O ), w )
                };
            ...
            }, function ( e, t ) {},,,,, function ( e, t )
            {
                ( function ( t )
                {
                    ...
                    function n ( e, t, n )
                    {
                        ...
                        return t = u ( t ) || 0, i ( n )
                            && ( M = !!n.leading, S = "maxWait" in n, y = S ? x ( u ( n.maxWait ) || 0, t ) : y, _ =
                                "trailing" in n ? !!n.trailing : _ ), m.cancel = l, m.flush = p, m
                    }
                    ...
                    function o ( e, t, o )
                    {
                        ...
                        return i ( o )
                            && ( r = "leading" in o ? !!o.leading : r, a = "trailing" in o ? !!o.trailing : a ), n (
                            e,
                            t,
                    ...
                    var c = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
                        ...
                        b = /^0o[0-7]+$/i,
                        v = parseInt;
                    const y = "object" == ( "undefined" == typeof t ? "undefined" : c ( t ) )
                        && t
                        && t.Object === Object
                        && t;
                    const g = "object" == ( "undefined" == typeof self ? "undefined" : c ( self ) )
                        && self
                        && self.Object === Object
                        && self;
            ...
            }, function ( e, t )
            {
                ( function ( t )
                {
                    ...
                    function n ( e, t, n )
                    {
                        ...
                        return t = a ( t ) || 0, o ( n )
                            && ( M = !!n.leading, S = "maxWait" in n, y = S ? k ( a ( n.maxWait ) || 0, t ) : y, _ =
                                "trailing" in n ? !!n.trailing : _ ), m.cancel = l, m.flush = p, m
                    }
                    ...
                    var u = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
                        ...
                        m = /^0o[0-7]+$/i,
                        b = parseInt;
                    const v = "object" == ( "undefined" == typeof t ? "undefined" : u ( t ) )
                        && t
                        && t.Object === Object
                        && t;
                    const y = "object" == ( "undefined" == typeof self ? "undefined" : u ( self ) )
                        && self
                        && self.Object === Object
                        && self;
            ...
            }, function ( e, t, n )
            {
                ...
                const a = function ( e, t )
                {
                    ...
                    {
                        e.node.classList.add ( "aos-init" ), e.position =
                            ( 0, r.default ) ( e.node, t.offset )
                    } ), e
                };
                t.default = a
            }, function ( e, t, n )

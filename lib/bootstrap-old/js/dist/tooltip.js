    ...
    ( function ( $, Popper, Util )
    {
        ...
        var Tooltip = /*#__PURE__*/function ()
        {
            ...
            _proto.show = function show ()
            {
                ...
                if ( this.isWithContent () && this._isEnabled )
                {
                    ...
                    $__default["default"] ( tip )
                        .addClass ( CLASS_NAME_SHOW ); // If this is a touch-enabled device we add extra
                    ...
                    if ( $__default["default"] ( this.tip ).hasClass ( CLASS_NAME_FADE ) )
                    {
                        ...
                        $__default["default"] ( this.tip ).one ( Util__default["default"].TRANSITION_END, complete )
            ...
            _proto.hide = function hide ( callback )
            {
                ...
                $__default["default"] ( tip )
                    .removeClass ( CLASS_NAME_SHOW ); // If this is a touch-enabled device we remove the extra
                ...
                if ( $__default["default"] ( this.tip ).hasClass ( CLASS_NAME_FADE ) )
                {
                    ...
                    $__default["default"] ( tip ).one ( Util__default["default"].TRANSITION_END, complete )
                        .emulateTransitionEnd ( transitionDuration );
                }
                else
                {
            ...
            _proto._enter = function _enter ( event, context )
            {
                ...
                if ( $__default["default"] ( context.getTipElement () ).hasClass ( CLASS_NAME_SHOW )

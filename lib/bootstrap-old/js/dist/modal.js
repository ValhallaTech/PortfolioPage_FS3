...
( function ( global, factory )
{
    typeof exports === "object" && typeof module !== "undefined"
        ...
        : typeof define === "function" && define.amd
          ...
          : ( global = typeof globalThis !== "undefined" ? globalThis : global || self, global.Modal =
    ...
    ( function ( $, Util )
    {
                ...
                if ( this._config.backdrop === "static" )
                {
                    ...
                    $__default["default"] ( this._element ).one ( Util__default["default"].TRANSITION_END,
                        function ()
                        {
                            ...
                            if ( !isModalOverflowing )
                            {
                                $__default["default"] ( _this3._element ).one ( Util__default["default"].TRANSITION_END,
                                    function ()
                                    {
            ...
            _proto._showBackdrop = function _showBackdrop ( callback )
                {
                    ...
                    if ( this._isShown && this._config.backdrop )
                    {
                        ...
                        const backdropTransitionDuration =
                            Util__default["default"].getTransitionDurationFromElement ( this._backdrop );
        ...
        $__default["default"] ( document ).on ( EVENT_CLICK_DATA_API,
            ...
            function ( event )
            {
                ...
                var $target = $__default["default"] ( target ).one ( EVENT_SHOW,
                    function ( showEvent )
                    {

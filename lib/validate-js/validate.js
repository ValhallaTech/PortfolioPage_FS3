...
( function ( window, document, undefined )
{
    ...
    const FormValidator = function ( formNameOrNode, fields, callback )
    {
    ...
    FormValidator.prototype._validateForm = function ( evt )
    {
        ...
        for ( let key in this.fields )
        {
            if ( this.fields.hasOwnProperty ( key ) )
            {
                ...
                const element = this.form[field.name];
    ...
    FormValidator.prototype._hooks = {
        ...
        {
            const result = field.value.split ( /\s*,\s*/g );
        ...
        {
            const enteredDate = this._getValidDate ( field.value );
            const validDate = this._getValidDate ( date );
